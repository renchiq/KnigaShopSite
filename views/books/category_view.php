        ...
        <div class="headPage__wrapper">
            <div class="headPage__breadcrumbs breadcrumbs">
                <ul class="breadcrumbs__list">
                    ...
                    <li class="breadcrumbs__item"><a href="/books-list/" class="breadcrumbs__link">Книги</a></li>
                    <li class="breadcrumbs__item"><?php echo CAT_DICT[$category]; ?></li>
                </ul>
            </div>
            <h2 class="headPage__title"><?php echo CAT_DICT[$category]; ?></h2>
        </div>
    </div>
</div>
<!-- конец пути -->
...
<section class="main_books">
    ...
    <div class="main_books__book-list book-list">
        ...
        <div class="book-list__books books">
            <!--Карточки книг-->
            <?php foreach ($booksByCategory as $num => $bookItem) : ?>
            <a href="/books-list/<?php echo $category; ?>/<?php echo $bookItem['id']; ?>">
